...
void ShaderParamsUpdate(int init)
{
  ...
  case LID_SLIPPERYCLIMB:
    ...
    { /* light sequence in ? state? */
      ...
      lid = ns.ldat->lid;
      if (lid != LID_DRNBRIO && lid != LID_STORMYASCENT && lid != LID_SLIPPERYCLIMB)
      {
        return;
      }
  ...
  case LID_FUMBLINGINTHEDARK:
    ...
    {
      if (dark_afx0_tgt > dark_afx0_next && (dark_afx0_next + dark_afx0_step >= dark_afx0_tgt) || dark_afx0_next < dark_afx0_tgt && (dark_afx0_tgt >= dark_afx0_step + dark_afx0_next))
      {
    ...
    {
      if (dark_dist_tgt > dark_dist_next && (dark_dist_next + dark_dist_step >= dark_dist_tgt) || dark_dist_next < dark_dist_tgt && (dark_dist_tgt >= dark_dist_step + dark_dist_next))
      {
